...
export default function ConversionPage() {
  ...
  const handleNumberConversion = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_PYTHON_API_URL}/convert/number`, {
        method: 'POST',
  ...
  const handleIpConversion = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_PYTHON_API_URL}/convert/ip`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
